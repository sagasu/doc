...
module.exports = (robot) ->
  ...
  robot.respond /who will be victorious/i, (msg)->
    msg.send "The Offshore team! :ahsan: :sachin: :kostas: :chris: :richard: :drmatt:"
  ...
  robot.respond /who will unleash righteous vengeance upon evil/i, (msg)->
    msg.send "The heroes of offshore team! :ahsan: :sachin: :kostas: :chris: :richard: :drmatt:"

  robot.respond /when all hope is lost and darkness is upon us/i, (msg)->
    msg.send "The offshore team shall know no fear! :ahsan: :sachin: :kostas: :chris: :richard: :drmatt:"
